...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>si', function() return builtin.find_files { hidden = true, no_ignore = true } end, { desc = '[S]earch Files [I]gnored' })
      vim.keymap.set('n', '<leader>sf', function() return builtin.find_files { hidden = true, no_ignore = false } end, { desc = '[S]earch [F]iles' })
  ...
  -- Very nice rust plugin
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>cd', function() vim.cmd.RustLsp 'debuggables' end, { desc = '[C]ode [D]ebug' })

      vim.keymap.set('n', '<leader>cD', function() vim.cmd.RustLsp 'debug' end, { desc = '[C]ode [D]ebug' })

      vim.keymap.set('n', '<leader>cu', function() require('dapui').toggle() end, { desc = '[C]ode [U]i (toggle debug UI)' })
